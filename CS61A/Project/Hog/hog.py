...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    ans = 0
    while i <= 10:
        avg = make_averaged(roll_dice, samples_count)(i, dice)
        if avg > max:
            max = avg
            ans = i
        i += 1
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    sus = sus_update(0, score, opponent_score)
    if sus - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    ans = 0
    while i <= 10:
        new_score = make_averaged(sus_update, 10)(i, score, opponent_score)
        if new_score > max:
            max = new_score
            ans = i
        i += 1

    return ans  # Remove this line once implemented.
    # END PROBLEM 12
